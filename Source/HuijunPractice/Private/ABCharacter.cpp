...
void AABCharacter::BeginPlay()
{
	...
	if (!IsPlayerControlled())
	{
		...
		{
			AssetStremingHandle = ABGameInstance->StreamableManager.RequestAsyncLoad(CharacterAssetToLoad, FStreamableDelegate::CreateUObject(this, &AABCharacter::OnAssetLoadCompleted));
		}
...
{
	USkeletalMesh* AssetLoaded = Cast<USkeletalMesh>(AssetStremingHandle->GetLoadedAsset());
	AssetStremingHandle.Reset();
