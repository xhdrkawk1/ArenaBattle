...
AABSection::AABSection()
{
	...
	{
		ABLOG(Error, TEXT("Faild staticmeshAsset: %s"), *AssetPath);
	}
	...
	{
		ABLOG(Error, TEXT("Faild staticmeshAsset: %s"), *GateAssetPath);
	}
	...
	for (FName GateSocket : GateSockets)
	{
		...
		NewGateTrigger->SetRelativeLocation(FVector(0.f, 0.f, 250.f));
...
void AABSection::OnTriggerBeginOverlap(UPrimitiveComponent* OverlappedComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OhterBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
	ABLOG_S(Warning);
...
void AABSection::OnGateTriggerBeginOverlap(UPrimitiveComponent* OverlappedComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OhterBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
